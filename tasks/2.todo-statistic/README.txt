...
1. Сейчас метод 'processCommand' обрабатывает только команду exit и завершает процесс в node.
...
4. Научись обрабатывать команды
...
5*. Научись обрабатывать команду
...
6*. Научись выводить результаты в консоль в виде таблицы:
...
7*. Научись подбирать ширину колонкам по самому длинному значению. Вот так:
...
8*. Добавь таблице заголовок из 4 колонок:
...
9*. Выводи в таблицах кроме информации из todo еще и имя файла, в котором этот todo найден.
Чтобы выделить имя файла из пути можно воспользоваться модулем path из Node.js:
https://nodejs.org/api/path.html#path_path_basename_path_ext

10*. По условиям задачи все todo имеют вид:
    // TODO Переделать это!
